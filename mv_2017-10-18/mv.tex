...
Im vergangenen Jahr begann der Vorstand seine arbeit mit einer Bestandsaufnahme der Veträge des Vereins und laufender Kosten. Die Mitgliederliste wurde aktualisiert und die Gemeinnützigkeit verlängert.
    * Geld bei Auflösung von Unimentor in Erfahrung gebracht
    * Konto bei GLS-Bank angelegt (Umzug steht aus)
    * Nichtzahler aufgearbeitet und Mahnungen gesendet
    * Verträge für den zweiten Freifunkserver sind wie vorgesehen auf Netz39 e.V. umgeschrieben
    * Zweckgebundene Spende für Freifunk für Serverfinanzierung verwendet
    * Umschreibung des Vodafonvertrags von Stefan Haun auf Vorstand
    * Internetvertrag Upgrade
    * Mitgliedsbeitragseinzug hat sich verschoben - normaler Rythmus wird wieder aufgenommen
    * Organisation für ein Reboot Treffen für Freifunk
    * Vorschlag zu Anpassung der Mahnungsordnung
